    ...
    .then((data) => {
        ...
        `
         ...
         if (typeOfWeather === "Clear") {
            weatherApp.innerHTML += `<img class="icon" src="./design/design2/icons/noun_Sunglasses_2055147.svg"><h2 class="description">Get your sunnies on. ${data.name} is looking rather great today.</h2>`
            weatherApp.style.color = "#2A5510"
            weatherApp.parentNode.style.backgroundColor = "#F7E9B9"
          } else if (typeOfWeather === "Clouds") {
            weatherApp.innerHTML += `<img class="icon" src="./design/design2/icons/noun_Cloud_1188486.svg"><h2 class="description">Light a fire and get cosy. ${data.name} is looking grey today.</h2>`
            ...
            weatherApp.innerHTML += `<img class="icon" src="./design/design2/icons/noun_Umbrella_2030530.svg"><h2 class="description">Don't forget your umbrella! It's wet in ${data.name} today!</h2>`
